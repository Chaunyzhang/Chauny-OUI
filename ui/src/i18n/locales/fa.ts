...
export const fa: TranslationMap = {
  ...
  configQuick: {
    ...
    automations: {
      ...
      skillInstalled: "{count} skill installed",
      skillsInstalled: "{count} skills installed",
    ...
    personal: {
      title: "Personal",
      userAria: "Your local chat identity",
      assistantAria: "Assistant identity",
      user: "User",
      you: "You",
      ...
      overrideHelp: "Stores a Control UI override. Clear it to return to IDENTITY.md.",
    ...
    presets: {
      ...
      otherConfigEditsPending:
        "Other staged config edits are pending. Saving here will commit all staged config changes.",
      chars: "{count} chars",
      contextEveryTurn: "Every turn",
      contextSkipSafeFollowups: "Skip safe follow-ups",
      contextEveryTurnDescription: "Reinject workspace bootstrap context on every turn.",
      contextSkipSafeFollowupsDescription:
      ...
      customValues: "Current values are custom. Choose a profile to stage a change.",
      options: {
        personal: {
